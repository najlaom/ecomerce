...
class ProductService {
  Future getProducts() async {
    //najlaaa
    var url = 'http://192.168.1.3:8085/api/products/getAll';
    //print(url);
  ...
  Future getProductsByCat(String categoryId) async {
    //najlaa
    var url = 'http://192.168.1.3:8085/api/products/getAllByIdCategory/' +
        categoryId;
  ...
  Future getProductByDetails(String productId) async {
    //najla
    var url = 'http://192.168.1.3:8085/api/products/getByIdWithDetais/' +
        productId;
    // print("urlllllllllllllll");
    // print(url);
  ...
  Future getDescriptionById(String descriptionId) async {
    //najla
    var url = 'http://192.168.1.3:8085/api/descriptions/getById/' +
        descriptionId;
  ...
  Future getProductsSponsor() async {
    //najlaaa
    var url = 'http://192.168.1.3:8085/api/products/getAllSponsor';
    //print(url);
    var searchResponse = await http.get(url);
    // print(searchResponse.body);
    //najla
  ...
  Future getProductsPromo() async {
    var url = 'http://192.168.1.3:8085/api/products/getAllPromo';
    //print(url);
    var searchResponse = await http.get(url);
    // print(searchResponse.body);
    //najla
