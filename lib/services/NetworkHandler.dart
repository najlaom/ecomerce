...

{
  ...
  Future<http.Response> addProduct(String url,Map<String,String>body,String token)async{
  ...
  Future<http.Response> ConfirmCommande(String url,Map<String,int>body,String token)async{
